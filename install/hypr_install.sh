...
# wlogou 开机关机功能
# ddccontrol 外接屏幕光度
sudo pacman -Syy pipewire-pulse pavucontrol mako hyprpaper waybar hyprlock hypridle brightnessctl copyq swayimg grim slurp wl-clipboard papirus-icon-theme 
# 图标主题
